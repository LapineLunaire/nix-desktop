# Base NixOS for full hosts: boot loader, escalation rules, zram, locale, console, and the firewall defaults, on top of the option namespace, nix settings, hardening, the uutils swap, persisted state, packages, services, and temp dir mounts.
{
  lib,
  outputs,
  pkgs,
